...
<body>
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><a class="nav-link"
							href="register.jsp">Register Now</a></li>
	...
	<div class="heading-title text-center" style="margin-top: 600px;">
		<h2>Register Now!</h2>
		<p>Register now to take benefits of our facilities.</p>
	</div>

	<form action="setcustomer" method="post"
		style="margin: 0 0 100px 0; min-height: 300px; display: flex; flex-direction: column; align-items: center; justify-content: space-between">
